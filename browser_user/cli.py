...
from browser_user.agent.views import AgentSettings
from browser_user.browser import BrowserProfile, BrowserSession
from browser_user.config import CONFIG
from browser_user.logging_config import addLoggingLevel
from browser_user.telemetry import CLITelemetryEvent, ProductTelemetry
...
def main(ctx: click.Context, debug: bool = False, **kwargs):
	...
	if kwargs.get('mcp'):
		...
		# Run as MCP server
		from browser_user.mcp.server import main as mcp_main
