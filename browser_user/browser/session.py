...
from browser_user.observability import observe_debug
from browser_user.utils import _log_pretty_path, _log_pretty_url
...
from browser_user.browser.profile import BROWSERUSE_DEFAULT_CHANNEL, BrowserChannel, BrowserProfile
from browser_user.browser.types import (
	Browser,
	BrowserContext,
	ElementHandle,
	FrameLocator,
...
from browser_user.browser.views import (
...
from browser_user.dom.views import DOMElementNode, SelectorMap
...
class BrowserSession(BaseModel):
		...
		if self.browser_context or self.browser:
			...
			if self.browser_profile.traces_dir and self.browser_context:
				try:
					...
					from browser_user.browser.types import TargetClosedError
	...
	async def get_state_summary(
		...
		if cache_clickable_elements_hashes:
			...
			from browser_user.dom.clickable_element_processor.service import ClickableElementProcessor
	...
	async def _get_updated_state(self, focus_element: int = -1, include_screenshot: bool = True) -> BrowserStateSummary:
		...
		try:
			...
			if is_empty_page:
				...
				from browser_user.dom.views import DOMElementNode, DOMState
			...
			try:
				...
				from browser_user.dom.views import DOMState
