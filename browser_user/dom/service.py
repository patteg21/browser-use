...
from browser_user.dom.views import (
	DOMBaseNode,
	DOMElementNode,
	DOMState,
	DOMTextNode,
...
from browser_user.utils import is_new_tab_page, time_execution_async
...
class DomService:
	...
	def __init__(self, page: 'Page', logger: logging.Logger | None = None):
		...
		self.js_code = resources.files('browser_user.dom.dom_tree').joinpath('index.js').read_text()
