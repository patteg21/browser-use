...
if TYPE_CHECKING:
	...
	from browser_user.llm.aws.chat_anthropic import ChatAnthropicBedrock
	from browser_user.llm.aws.chat_bedrock import ChatAWSBedrock
	from browser_user.llm.azure.chat import ChatAzureOpenAI
	from browser_user.llm.deepseek.chat import ChatDeepSeek
	...
	from browser_user.llm.openrouter.chat import ChatOpenRouter

# Lazy imports mapping for heavy chat models
_LAZY_IMPORTS = {
	'ChatAnthropic': ('browser_user.llm.anthropic.chat', 'ChatAnthropic'),
	'ChatAnthropicBedrock': ('browser_user.llm.aws.chat_anthropic', 'ChatAnthropicBedrock'),
	'ChatAWSBedrock': ('browser_user.llm.aws.chat_bedrock', 'ChatAWSBedrock'),
	'ChatAzureOpenAI': ('browser_user.llm.azure.chat', 'ChatAzureOpenAI'),
	'ChatDeepSeek': ('browser_user.llm.deepseek.chat', 'ChatDeepSeek'),
	...
	'ChatOpenRouter': ('browser_user.llm.openrouter.chat', 'ChatOpenRouter'),
}
